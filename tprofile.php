...
<b id="logout"><a style="position: relative;left: 800px" href="logout.php">Log Out</a></b>
</div>
        <div class="container">
            ...
            <div class="controls">
                  <button id="attend" class="btn btn-success">Take Attendance</button>
  <script>
    ...
    btn.addEventListener('click', function() {
      document.location.href = 'test.php';
            ...
            <div class="controls">
                  <button id="updatehw" class="btn btn-success">Update Home Work</button>
  <script>
    var btn = document.getElementById('updatehw');
    btn.addEventListener('click', function() {
