    ...
    <body id="page-top">
        ...
        <div class="container">
            <h2>Register Class:</h2>
               <form action="hwclr.php" method="POST" role="form">
                        	<div class="form-body">
                            <fieldset>
                                ...
                                <div class="form-group">	
                                <label>Grade</label>
                                <input type="text" placeholder="Grade" name="grade" class="form-control" required="">
                                 </div>
        ...
        <div style="position: relative;left:70px;top: 10px">
            <div class="controls">
                  <button id="login" class="btn btn-success" style="">View HW</button>
  <script>
