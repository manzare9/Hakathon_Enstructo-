...
$query="insert into admin_data (username,password,email,address,mobileno) values ('$username','$password','$email','$address','$mobile')";
...
else
{
  ...
  <script>
    ...
    btn.addEventListener('click', function() {
      document.location.href = 'loginadminview.php';
    });
  </script>
                </div></div>
    </h2>