...
<b id="logout"><a style="position: relative;left: 800px" href="adminlogout.php">Log Out</a></b>
        ...
        <div class="container">
            ...
            <div class="controls">
                  <button id="register" class="btn btn-success">View Daily HW</button>
  <script>
    var btn = document.getElementById('register');
    btn.addEventListener('click', function() {
      document.location.href = 'viewhwelse.php';
    });
  </script>
                </div></div>
  ...
  <script>
    ...
    btn.addEventListener('click', function() {
      document.location.href = 'discussion.php';
            ...
            <div class="controls">
                  <button id="noticeboard" class="btn btn-success">View Notice Board</button>
  <script>
    var btn = document.getElementById('noticeboard');
    btn.addEventListener('click', function() {
      document.location.href = 'tnsinfo.php';
    });
  </script>
                </div></div>
