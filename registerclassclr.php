...
$username= filter_input(INPUT_POST,'stname');
$regsno=  filter_input(INPUT_POST, 'regno');
$pname=filter_input(INPUT_POST,'pname');
$email=filter_input(INPUT_POST,'email');
$pmobile=filter_input(INPUT_POST,'pmobile');
$smstr=filter_input(INPUT_POST,'grade');
$ses=filter_input(INPUT_POST,'sessions');

$query="insert into attendance1 (std_reg_no,std_name,parentemail,parentmobile,parentname,semester_id,total_classes) values ('$regsno','$username','$email','$pmobile','$pname','$smstr','$ses')";
